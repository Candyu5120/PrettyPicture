...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-64 bg-content1/90 backdrop-blur-xl border-r border-divider transform transition-transform duration-300 lg:translate-x-0 ${
