...
CREATE TABLE `tp_images` (
  ...
  `folder_id` int(11) NOT NULL DEFAULT '0' COMMENT '目录ID',
...
CREATE TABLE `tp_folder` (
  ...
  `is_public` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否开放随机API 0否 1是',
...
INSERT INTO `tp_log` (`id`, `uid`, `type`, `content`, `operate_id`, `operate_cont`, `create_time`) VALUES
...
CREATE TABLE `tp_storage` (
  ...
  `endpoint` varchar(255) DEFAULT NULL COMMENT 'Endpoint地址'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tp_storage` (`id`, `type`, `name`, `space_domain`, `AccessKey`, `SecretKey`, `region`, `bucket`, `endpoint`) VALUES
(1000, 'local', '本地存储桶', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `tp_system` (`id`, `key`, `attr`, `type`, `title`, `des`, `value`, `extend`) VALUES
...
(10, 'upload_max', 'number', 'upload', '上传最大尺寸/MB', '单个文件最大上传大小', '50', NULL),
(12, 'upload_rule', 'input', 'upload', '允许上传后缀', '多个后缀用英文逗号分隔', 'jpg,jpeg,gif,png,ico,svg,webp', NULL),
...
CREATE TABLE `tp_user` (
  ...
  `Secret_key` varchar(64) DEFAULT NULL COMMENT 'API秘钥',
